...
CONFIG = {
    ...
    "labels": ["bulbasaur", "charmander", "jigglypuff" ,"mewtwo", "pikachu", "rayquaza", "squirtle"],
    ...
    # respectively
    "pokedex": os.path.sep.join(["assets", "pokedex.png"]),
    "pokedex_mask": os.path.sep.join(["assets", "pokedex_mask.png"]),
...
while True:
    ...
    pokedex = cv2.bitwise_and(pokedex, pokedex, mask=pokedexMask)
